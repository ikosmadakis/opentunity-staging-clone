...
class ElectricalSpecs(models.Model):
    ...
    power_consumption_units     = models.ForeignKey(Units, on_delete=models.PROTECT, related_name='+')
...
class Asset(models.Model):
    ...
    electrical_specs = models.ForeignKey(ElectricalSpecs, on_delete=models.PROTECT)
    bess_specs       = models.ForeignKey(BESSSpecs, on_delete=models.PROTECT)
